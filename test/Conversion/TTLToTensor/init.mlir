...
func.func @matrix_rand_init() -> !ttl.tensor<2x2x!ttl.int> {
  %0 = "ttl.tensor_random_init"() : () -> !ttl.tensor<2x2x!ttl.int>
...
// CHECK:           %[[VAL_0:.*]] = "ttl.tensor_random_init"() : () -> !ttl.tensor<2x2x!ttl.int>
// CHECK:           "ttl.return"(%[[VAL_0]]) : (!ttl.tensor<2x2x!ttl.int>) -> ()
// CHECK:         }
